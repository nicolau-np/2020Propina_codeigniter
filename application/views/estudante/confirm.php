...
foreach ($getEstudante as $estudante) {
    $this->session->set_userdata("ano_lectivo_actualCONF", $estudante->ano_lectivo);
    $this->session->set_userdata("bi_actualCONF", $estudante->bi);
}
?>
<div class="module">
    ...
    <div class="module-body">
        ...
        <form class="form-horizontal row-fluid" name="form_cad" method="post"
              action="<?php echo base_url() . "estudante/confirm_save"; ?>">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <select tabindex="1" name="genero" id="genero" data-placeholder="Selecione..." class="span3">
                        <option value="<?php echo $estudante->genero; ?>"><?php if ($estudante->genero == "M"): echo "Masculino"; else: echo "Femenino";endif; ?></option>
            ...
            <div class="control-group">
                <label class="control-label field" for="data_nascimento"><span class="obrigatorio">*</span> Data de
                    Nascimento:</label>
                <div class="controls">
                    <input type="date" name="data_nascimento" id="data_nascimento" class="span3"
                           value="<?php echo $estudante->data_nascimento; ?>"/>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="bi" id="bi" placeholder="Nº do B.I" class="span3"
                           value="<?php echo $estudante->bi; ?>"/>
                ...
                <div class="controls">
                    <select tabindex="1" name="id_turma" id="id_turma" data-placeholder="Selecione..." class="span3">
                        ...
                        foreach ($getTurmas as $turmas):
                            if ($turmas->turma == $estudante->turma):
                                ?>
            ...
            <div class="control-group">
                <label class="control-label field" for="ano_lectivo"><span class="obrigatorio">*</span> Ano
                    Lectivo:</label>
                <div class="controls">
                    <input type="number" name="ano_lectivo" id="ano_lectivo" placeholder="Ano" class="span2"
                           value="<?php echo set_value('ano_lectivo'); ?>"/>
