<script>
    $(document).ready(function () {
        ...
        function carregar_registros() {
            $.ajax({
                type: 'post',
                url: '<?php echo base_url() . "pagamento/datatable"; ?>',
                data: '',
                beforeSend: function () {
        ...
        function pesquisar(nome) {
            $.ajax({
                type: 'post',
                url: '<?php echo base_url() . "pagamento/pesquisa"; ?>',
                data: {nome: nome},
                beforeSend: function () {
                    $(".data_table").text("carregando...");
                },
        ...
        function carregar_paginacao(pagina) {
            $(".data_table").load("<?php echo base_url() . 'pagamento/datatable/'; ?>" + pagina);
        }
    });
</script>
<div class="module">
    ...
    <div class="module-body">
        ...
        <form class="form-horizontal row-fluid" name="form_pesquisa" method="post" action="#">
            <div class="span4">
                ...
                &nbsp;&nbsp;&nbsp;
                <a href="<?php echo base_url() . "pagamento/novo"; ?>" title="Novo" id="new" class="btn btn-success"><i
            ...
            <div class="span6">
                <div class="control-group">
                    <div class="controls">
                        ...
                        <button name="bt_pesquisar" type="submit" class="btn btn-primary"><i
