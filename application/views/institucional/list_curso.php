<script>
    $(document).ready(function () {
        ...
        function carregar_registros() {
            $.ajax({
                type: 'post',
                url: '<?php echo base_url() . "institucional/datatable_curso"; ?>',
                data: '',
                beforeSend: function () {
        ...
        function carregar_paginacao(pagina) {
            $(".data_table").load("<?php echo base_url() . 'institucional/datatable_curso/'; ?>" + pagina);
        }
    });
</script>
<div class="module">
    ...
    <div class="module-body">
        ...
        <form class="form-horizontal row-fluid" name="form_pesquisa" method="post" action="#">
            <div class="span4">
                ...
                &nbsp;&nbsp;&nbsp;
                <a href="<?php echo base_url() . "institucional/novo_curso"; ?>" title="Novo" id="new" class="btn btn-success"><i class="icon icon-plus"></i></a>
                &nbsp;&nbsp;&nbsp;
            ...
            <div class="span6">
                <div class="control-group">
                    <div class="controls">
                        <input type="text" id="basicinput" placeholder="pesquisar..." class="span9">
